...
var index_config_default = {
 ...
 t4: {list: [
    ...
    {name: "👖裤佬丨瓜子丨影视",
      address: "https://newtv.ggff.net/guazi?token=LOO8vZfB"},
    {name: "👖裤佬丨瓜子丨备用",
      address: "https://catbox.n13.club/ai/瓜子影视.php"},
    {name: "👖裤佬丨永乐丨影视",
      address: "https://newtv.ggff.net/yongle?token=LOO8vZfB"},
    {name: "👖裤佬丨欧乐丨影视",
      address: "https://newtv.ggff.net/oule?token=LOO8vZfB"},
    {name: "👖裤佬丨荐片丨影视",
      address: "https://newtv.ggff.net/jianpian?token=LOO8vZfB"},
    {name: "👖裤佬丨ikbot丨影视",
      address: "https://newtv.ggff.net/ikanbot?token=LOO8vZfB"},
    {name: "👖裤佬丨剧吧丨影视",
      address: "https://newtv.ggff.net/jubaba?token=LOO8vZfB"},
    {name: "👖裤佬丨奇优丨影视",
      address: "https://newtv.ggff.net/uvod?token=LOO8vZfB"},
    {name: "👖裤佬丨爱瓜丨影视",
      address: "https://newtv.ggff.net/aigua?token=LOO8vZfB"},
    {name: "👖裤佬丨3Q丨影视",
